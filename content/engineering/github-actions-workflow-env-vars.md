---
aliases: [/blog/github-actions-workflow-env-vars/]
title: "GitHub Actions Workflow Env Vars"
date: 2022-01-08T15:13:52Z
tags: [engineering, "github actions", linux, windows, syntax, "self-hosted runner", "environment variables", workflow, cicd]
---


In this article, you'll learn how GitHub Actions evaluates contexts, configuration variables, secrets, and runner environment variables at different times. That matters because durable engineering comes from understanding trade-offs, not merely reproducing a command or pattern.
...
Most GitHub Actions variable surprises disappear once evaluation time, runner shell, sensitivity, and scope are treated as four separate questions.
