---
aliases: [/blog/hybrid-origins-http-traffic/]
title: "Hybrid Origins Http Traffic"
date: 2022-01-15T17:25:37Z
draft: false
tags: [engineering, cloudflare, dns, "uri forwarder", "page rules", zones, domain, hostname]
---


In this article, you'll learn how DNS, redirects, reverse proxies, and origin routing differ when one hostname spans several platforms. That matters because durable engineering comes from understanding trade-offs, not merely reproducing a command or pattern.
...
Hybrid routing is manageable when DNS, redirects, proxies, and origins each have one explicit responsibility; ambiguity between them is what turns a migration into a maze.
